...
export function LumpsumCalculator() {
  ...
  const results = calculateLumpsum(investment, returnRate, duration);
    ...
    <div className="w-full flex flex-col gap-6">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 items-start">
        ...
        <div className="md:col-span-8 lg:col-span-6 bg-white p-4 md:p-6 rounded-[20px] shadow-sm border border-gray-100 flex flex-col">
          ...
          <div className="text-[9px] text-text-body/60 mt-4">* Compounded annually. Values are estimated and for illustration purpose only.</div>
        </div>
      ...
      <div className="w-full bg-[#0F172A] rounded-[20px] p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl relative overflow-hidden mt-4">
        ...
        <div className="flex items-center gap-4 relative z-10 w-full md:w-auto">
          ...
          <div className="text-left flex-1">
            ...
            <p className="text-white/60 text-[11px] max-w-sm leading-relaxed">Talk to our experts and create a personalised investment plan.</p>
          </div>
        </div>
