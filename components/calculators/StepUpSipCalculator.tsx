...
import { User, TrendingUp, Info, Wallet, Calculator, Coins, ShieldCheck, PieChart as PieChartIcon, ArrowRight, Download, Crown, LineChart } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6 items-start">
        ...
        <div className="lg:col-span-3 bg-white p-4 md:p-5 rounded-[20px] shadow-sm border border-gray-100 flex flex-col gap-5 md:gap-6">
          <div className="flex items-center gap-2 text-navy border-b border-gray-100 pb-4">
            ...
            <h2 className="text-[15px] font-bold font-heading">Step-Up SIP Details</h2>
          </div>
          <p className="text-[11px] text-text-body -mt-4">Adjust the sliders to see real-time results</p>

          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <label className="text-[12px] font-bold text-navy">Starting Monthly SIP</label>
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <label className="text-[12px] font-bold text-navy">Annual Step-Up</label>
              <div className="relative w-20">
                <Input 
                  type="number" 
                  value={annualStepUp} 
          ...
          <div className="bg-lime/10 p-3 rounded-xl flex items-start gap-2 mt-2">
            ...
            <p className="text-[11px] text-navy/80 leading-relaxed font-medium">
              A {annualStepUp}% annual step-up significantly boosts your final maturity value.
            </p>
          </div>
        </div>
          ...
          <div className="bg-white p-5 rounded-[20px] shadow-sm border border-gray-100 flex-1">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-[11px] text-navy/90 leading-relaxed font-medium">Projected value is <strong>{(results.maturityValue / results.totalInvestment).toFixed(2)}x</strong> in {duration} years</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-md bg-lime/10 flex items-center justify-center shrink-0 mt-0.5">
                  <LineChart className="w-3 h-3 text-lime" />
                </div>
                <p className="text-[11px] text-navy/90 leading-relaxed font-medium">Stepping up your SIP helps you easily beat inflation over time</p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-md bg-lime/10 flex items-center justify-center shrink-0 mt-0.5">
                  <TrendingUp className="w-3 h-3 text-lime" />
                </div>
                <p className="text-[11px] text-navy/90 leading-relaxed font-medium">Your SIP amount in the final year will be <strong>{formatCurrencyExact(results.finalMonthlySIP)}</strong></p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-6 h-6 rounded-md bg-lime/10 flex items-center justify-center shrink-0 mt-0.5">
