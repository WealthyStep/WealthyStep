...
{/* MIDDLE COLUMN: RESULTS & CHART */}
        <div className="lg:col-span-6 bg-white p-4 md:p-6 rounded-[20px] shadow-sm border border-gray-100 flex flex-col">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-gray-100 pb-4 mb-4">
            <div>
              <div className="flex items-center gap-2 text-navy mb-1"><Target className="h-5 w-5 text-lime" /><h2 className="text-[15px] font-bold font-heading">Education Fund Projection</h2></div>
          ...
          <div className="text-[13px] font-bold text-navy mb-4">Projected Savings vs Target Cost</div>
          ...
          <div className="text-[9px] text-text-body/60 mt-4">* Assumptions: {inflationRate}% education inflation, {returnRate}% expected return. SIP at beginning of month. These calculations are illustrative estimates based on the inputs and assumptions provided. They are not a guarantee of future returns or outcomes.</div>
        </div>
      ...
      <div className="w-full max-w-5xl mx-auto bg-[#180D45] rounded-[20px] p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6 shadow-xl relative overflow-hidden mt-4">
        ...
        <div className="flex items-center gap-4 relative z-10 w-full md:w-auto">
          ...
          <div className="text-left flex-1">
            ...
            <p className="text-white/60 text-[11px] max-w-sm leading-relaxed">Talk to our experts and explore mutual fund solutions for education goals.</p>
          </div>
        </div>
