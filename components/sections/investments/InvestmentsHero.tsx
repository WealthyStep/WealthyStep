...
import { ArrowRight, ShieldCheck, FileSearch, Users } from "lucide-react";

export function InvestmentsHero() {
  return (
    <section className="relative bg-[#0F172A] pt-12 md:pt-16 pb-20 md:pb-24 overflow-hidden z-20">
          ...
          <div className="text-white max-w-xl">
            <FadeIn direction="up">
              ...
              <h1 className="text-4xl sm:text-5xl lg:text-[56px] font-bold font-heading leading-[1.1] tracking-tight mb-4">
                ...
                For <span className="text-lime">Every Goal.</span>
              </h1>
            ...
            <FadeIn direction="up" delay={0.2} className="flex flex-wrap items-center gap-6 sm:gap-10 mt-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs sm:text-sm font-medium text-white/90 leading-tight">Transparent &<br/>Fee Disclosure</span>
              </div>
              <div className="flex items-center gap-3">
