...
export function WhatsAppButton() {
  ...
  return (
    <div
      className={cn(
        "fixed bottom-24 right-6 z-40 flex items-end justify-end transition-all duration-700 transform",
    ...
    >
      <div className="relative group">
        ...
        <a
          ...
          className="relative flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-full shadow-2xl transition-all duration-500 hover:scale-110 hover:-translate-y-2 group/btn outline-none focus-visible:ring-4 focus-visible:ring-[#25D366]/50 bg-gradient-to-tr from-[#1EBE57] to-[#25D366] overflow-hidden"
        ...
        >
          ...
          <svg
            viewBox="0 0 24 24"
            fill="white"
            className="w-6 h-6 md:w-7 md:h-7 relative z-10 transform group-hover/btn:rotate-12 transition-transform duration-300"
          >
