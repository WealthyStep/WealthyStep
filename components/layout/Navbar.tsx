            ...
            <div className="flex items-center justify-between h-16 md:h-20">
              ...
              <div className="flex items-center gap-2 xl:gap-3 shrink-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="hidden lg:flex items-center justify-center w-10 h-10 rounded-full bg-white border border-gray-200 shadow-sm text-navy hover:border-navy hover:shadow-md transition-all"
                ...
                <a
                  ...
                  className="hidden lg:flex items-center justify-center w-10 h-10 rounded-full bg-white border border-lime shadow-sm text-lime hover:bg-lime hover:text-navy hover:shadow-md transition-all"
                  aria-label="Call us"
                >
