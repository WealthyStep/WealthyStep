      ...
      <div className="container mx-auto max-w-[1200px] px-4 xl:px-0">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <a href="https://x.com/Wealthy_Step" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/80 hover:text-white hover:border-lime hover:bg-white/5 transition-all group" aria-label="X (Twitter)">
                <svg className="w-4 h-4 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                </svg>
              </a>
              <a href="https://www.youtube.com/@WealthyStep" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/80 hover:text-white hover:border-lime hover:bg-white/5 transition-all group" aria-label="YouTube">
              ...
              <a href="https://www.instagram.com/wealthy.step/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/80 hover:text-white hover:border-lime hover:bg-white/5 transition-all group" aria-label="Instagram">
            ...
            <div className="pt-4 flex gap-3">
              <a href="https://apps.apple.com/us/app/wealthy-step/id6751190719" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 border border-white/20 hover:border-lime hover:bg-white/5 rounded-md py-2 px-3 transition-all text-[11px] font-semibold w-max">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.wealthystep.wealthystep&hl=en_IN" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2 border border-white/20 hover:border-lime hover:bg-white/5 rounded-md py-2 px-3 transition-all text-[11px] font-semibold w-max">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-cream/70">
              ...
              <li>
                <a href="/AMFI_Code-of-Conduct.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between hover:text-lime transition-colors group">
                  Code of Conduct
                  <ChevronRight className="w-4 h-4 opacity-50 group-hover:opacity-100 group-hover:translate-x-1 transition-all" />
                </a>
              </li>
        ...
        <div className="mt-8 flex flex-col items-center lg:items-start justify-between border-t border-white/10 pt-6 pb-4 text-[10px] md:text-[11px] xl:text-xs text-cream/70 lg:flex-row gap-6">
          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-center gap-x-2 xl:gap-x-3 gap-y-2 items-center">
            ...
            <span className="hidden lg:inline text-white/20">|</span>
            <a href="https://www.sebi.gov.in/filings/mutual-funds.html" target="_blank" rel="noopener noreferrer" className="py-1 hover:text-white transition-colors whitespace-nowrap">SID/SAI/KIM</a>
            <span className="hidden lg:inline text-white/20">|</span>
            <a href="/AMFI_Code-of-Conduct.pdf" target="_blank" rel="noopener noreferrer" className="py-1 hover:text-white transition-colors whitespace-nowrap">Code of Conduct</a>
            <span className="hidden lg:inline text-white/20">|</span>
            ...
            <span className="hidden lg:inline text-white/20">|</span>
            <a href="https://www.sebi.gov.in/sebiweb/home/HomeAction.do?doListingAll=yes&search=Mutual+Funds" target="_blank" rel="noopener noreferrer" className="py-1 hover:text-white transition-colors whitespace-nowrap">SEBI Circulars</a>
          </div>
        </div>
      </div>
    </footer>
